...
At the time of writing this proposal, we are \new{three signatures away.  Not sure about how far away we are at this point.  It seems to be stalled for a reason I can't figure out the global health crisis isn't helping either. } from implementing an Associates in Physics (A.S.) in Physics degree at QCC.  Having a formalized program with clear prerequisites, course requirements, and transfer expectations will greatly facilitate the creation of a pipeline of physics majors.  Students will receive improved and streamlined advising in this program, compared to the hodgepodge they receive today.  

One course we are adding to the physics major program is the ``Colloquium Course,'' which involves a weekly seminar on a current topic in physics \new{given by whom?  This will be the assigned professor of the course.  I'm hoping this course will be a little more like journal club where both faculty and students prepare presentations on recently and fundamental papers.  Not sure how much we need to say about this here though}.  This seminar will excite students as well as build cohesion among them.  \new{Cohort-building is great...  Yes it is.  Do we want to talk about Cohort building here or below where we talk about social and academic activities.  I added some words about cohorts down there.}
...
\subsection{Faculty Mentoring Training}
...
Before the start of the year, faculty interested in mentoring S-STEM students will be required to participate in a 2 hour faculty mentoring workshop.  During the workshop we will several main topics.  The first will be an overview of the program and an overview of the students enrolled in the cohort.  It is important that the faculty are aware of the challenges that are facing the students that they have agreed to mentor.  We will be some guidelines of sensitivity training and sexual harassment training provided by the diversity office of the college to ensure that each of the mentors is aware of the policies and procedures surrounding appropriate behavior and reporting guidelines.  After the overview of policies procedures and general guidelines for the program we will go into specific mentoring strategies that have been shown to be effective. We will discuss the creation and maintenance of both an independent development plan for undergraduates and mentoring maps.  Because these are required material from the mentors detailed instructions of how and when to provide the original documents and when to provide updates. There will also be a portion of the mentor training for mentors to share things that worked and things that did not from previous mentoring experiences.  In preparation for the last portion of the workshop each faculty mentor will be asked to complete a quick survey that identifies how many students they can support, a brief description of their project and to identify one thing that worked for them when mentoring and one thing that they tried but was unsuccessful. 

The end of year meeting will be a time to touch base with each of the mentors and get some information about how the year went.  This will be when informal interviews will be conducted with each of the mentors regarding their mentoring experience and their perceived experience of the student.  This feedback will then be compared to a student response to ensure that the experience was perceived similarly by both parties in the relationship.  Where conflicts are identified the PIs can intervene and attempt to improve the relationship.
...
We will encourage students and faculty to participate in local scientific conferences, such as the Astronomical Society of New York (ASNY) or \new{insert physics meeting here.  AAPT? CUWiP?}.  Presenting results and meeting scholars from other institutions is a great way to inspire students and motivate them toward academic excellence.  S-STEM scholars will also be required to present their research at QCC Undergraduate Research Day, which occurs at the end of the Fall and Spring semesters.

\new{Do we want to mention things like tutoring and/or academic support?  I'm not all that familiar with how tutoring works.  We don't have very good tutoring for physics so if we want it, we should propose it here. }
